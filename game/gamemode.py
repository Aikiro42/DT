...
font_scale = window.height / 864
code_font_size = floor(15*font_scale) + 1

codeline_label = Label(gamevars.codeline_str, font_name="Consolas", font_size=code_font_size)
...
code_textbox = Textbox(window.batch, width=7 * window.width // 8, font_name='Consolas', font_size=code_font_size, pad=10)
